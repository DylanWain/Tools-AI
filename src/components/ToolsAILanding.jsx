  ...
  return (
    <div style={{ background: "#fafaf9", color: "#111", fontFamily: "'Plus Jakarta Sans',sans-serif", minHeight: "100vh", overflowX: "hidden", WebkitFontSmoothing: "antialiased", position: "relative" }}>
      ...
      <nav style={{
        ...
        <a href="https://github.com/DylanWain/Tools-AI-APP/releases/download/v1.0.6/Tools.AI-1.0.0-universal.dmg" download style={{
      ...
      <footer style={{ textAlign: "center", padding: "32px 40px 48px", borderTop: "1px solid #e8e8e4", position: "relative", zIndex: 1 }}>
        <div style={{ fontSize: 12, color: "#bbb" }}>
          <a href="https://github.com/DylanWain/Tools-AI-APP/releases/download/v1.0.6/Tools.AI-1.0.0-universal.dmg" download style={{ color: "#999", textDecoration: "none" }}>Privacy Policy</a>{" · "}<a href="#" style={{ color: "#999", textDecoration: "none" }}>Terms of Service</a>
        </div>
