...
const faqs = [
  ...
  },
  {
    ...
    a: "Every account starts with $5 of usage for free — no card needed. Once you hit the cap, pick a plan: $25/month flat (includes $25 of usage at the base rate, 2× after) or pay-as-you-go at 3× per use with no monthly fee. The plan picker appears in your chat as soon as you exceed the free amount.",
  },
  {
    q: "Can I cancel?",
